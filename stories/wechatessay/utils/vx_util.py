...
def scan_article_files(txt_file_path: str, output_dir: str = None) -> list:
    ...
    Args:
        ...
        output_dir: 文章保存目录，默认为项目 wechatessay_old/backends/sources 目录
    ...
    # 计算 wechatessay_old 根目录（用于生成相对路径）
    wechatessay_root = os.path.dirname(os.path.dirname(output_dir))  # 向上回退两级到 wechatessay_old
    ...
    async def crawl_and_save(url: str, index: int) -> str | None:
        ...
        try:
            ...
            # 返回相对于 wechatessay_old 根目录的相对路径
