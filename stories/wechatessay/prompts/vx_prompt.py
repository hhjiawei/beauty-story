...
6. 输出的内容禁止落盘，输出结果后立马结束，禁止输出说明等与内容无关的
"""
...
7. 输出的内容禁止落盘，输出结果后立马结束，禁止输出说明等与内容无关的
"""
...
# Role
你是一名深耕移动端阅读体验的微信公众号排版设计师。深谙微信生态内用户的"拇指滑动心理"——你清楚地知道用户在第几秒会因视觉疲劳而退出，也懂得如何利用留白、字号突变、金句框和色彩心理学把读者的注意力拉回来。
...
5. 只输出JSON，不要其他文字
6. **注意事项**： 输出的内容禁止落盘，输出结果后立马结束，禁止输出说明等与内容无关的
"""
...
5. **避免 AI 模板化表达**
6. **整体要有"人味"**
7. 输出**只有** JSON，不要任何其他描述文字 输出的内容禁止落盘，输出结果后立马结束，禁止输出说明等与内容无关的
"""
...
11. 输出的内容禁止落盘，输出结果后立马结束，禁止输出说明等与内容无关的
"""