...
# ═══════════════════════════════════════════════
# 节点5-Review: review_node — 多模型评审 Prompt
# ═══════════════════════════════════════════════
...
# Task
请对以下公众号文章进行专业评审，从自己的专业角度给出客观、具体的评价。
你的评审将直接决定文章是否需要修改。
...
# 输出格式
请严格按照以下 JSON 格式输出评审结果，不要有任何其他文字：
...
{{
  ...
  "revisionSuggestions": "具体的修改建议汇总，直接面向写手，说明需要改什么、怎么改。如果没有问题则写'无明显问题，无需修改'。"
}}

# 评审规则
1. 必须逐项检查所有评审维度
2. 问题描述要具体，指明在文章的哪个位置、什么问题、怎么改
3. 评分要客观公正，不刻意挑刺也不放过问题
